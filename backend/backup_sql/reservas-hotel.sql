...
--
-- Host: 127.0.0.1
-- Tempo de geração: 30-Maio-2023 às 22:11
...
(5, 'Administrador', 'Hotel Portobelo', 'portobelo', '$2a$07$asxx54ahjppf45sd87a5aujnds32V/FMhy.OEhSAq8T6ZZ.ItVK.O', 1, '2023-05-25 18:34:04'),
(10, 'Administrador', 'Hemel Aly', 'hemel', '$2a$07$asxx54ahjppf45sd87a5auRajNP0zeqOkB9Qda.dSiTb2/n.wAC/2', 0, '2023-05-25 22:37:18'),
(11, 'Editor', 'Samuel Licenga', 'samuel', '$2a$07$asxx54ahjppf45sd87a5auRajNP0zeqOkB9Qda.dSiTb2/n.wAC/2', 0, '2023-05-25 22:37:20'),
(12, 'Administrador', 'Gilberto Manhica', 'gilberto', '$2a$07$asxx54ahjppf45sd87a5auRajNP0zeqOkB9Qda.dSiTb2/n.wAC/2', 1, '2023-05-25 22:39:49'),
(13, 'Editor', 'Sydney Fox', 'hmedfrf', '$2a$07$asxx54ahjppf45sd87a5auCjOduR9uwPMKkROW5Fb/wfDKfX3S8Qi', 0, '2023-05-25 22:59:11'),
(14, 'Administrador', 'juan urrego', 'juan', '$2a$07$asxx54ahjppf45sd87a5auBoYjNMoP3m.rqYEoDZuWcXkvfARiYYC', 1, '2023-05-26 22:16:07'),
(15, 'Administrador', 'juan urrego', 'juan', '$2a$07$asxx54ahjppf45sd87a5auBoYjNMoP3m.rqYEoDZuWcXkvfARiYYC', 0, '2023-05-25 22:39:40'),
(17, 'Editor', 'Jose Cuinica', 'jose', '$2a$07$asxx54ahjppf45sd87a5auBoYjNMoP3m.rqYEoDZuWcXkvfARiYYC', 1, '2023-05-25 22:41:51'),
(18, 'Administrador', 'Elisa Mola', 'elisa', '$2a$07$asxx54ahjppf45sd87a5auRajNP0zeqOkB9Qda.dSiTb2/n.wAC/2', 0, '2023-05-25 22:42:45'),
(19, 'Administrador', 'Elisa Mola', 'elisa', '$2a$07$asxx54ahjppf45sd87a5auRajNP0zeqOkB9Qda.dSiTb2/n.wAC/2', 0, '2023-05-25 22:43:07'),
(20, 'Administrador', 'Gerson Melembe', 'gerson', '$2a$07$asxx54ahjppf45sd87a5auRajNP0zeqOkB9Qda.dSiTb2/n.wAC/2', 1, '2023-05-28 06:02:44');
...
(7, 'vistas/img/banner/banner01.jpg', '2019-04-09 16:14:31');
...
(1, 'habitacion-tipo-suite', '#847059', 'suite', 'vistas/img/suite/portada.png', 'Lorem ipsum dolor sit amet', '[{ \"item\": \"cama 2 x 2\", \"icono\": \"fas fa-bed\"},\r\n{ \"item\": \"TV de 42 Pulg\", \"icono\": \"fas fa-tv\"},\r\n{ \"item\": \"Agua Caliente\", \"icono\": \"fas fa-tint\"},\r\n{ \"item\": \"Jacuzzi\", \"icono\": \"fas fa-water\"},\r\n{ \"item\": \"Baño privado\", \"icono\": \"fas fa-toilet\"},\r\n{ \"item\": \"Sofá\", \"icono\": \"fas fa-couch\"},\r\n{ \"item\": \"Balcón\", \"icono\": \"far fa-image\"},\r\n{ \"item\": \"Servicio Wifi\", \"icono\": \"fas fa-wifi\"}]', 350000, 300000, 420000, 380000, '2023-05-17 23:09:32'),
(2, 'habitacion-tipo-especial', '#197DB1', 'especial', 'vistas/img/especial/portada.png', 'Lorem ipsum dolor sit amet', '[{ \"item\": \"cama 2 x 2\", \"icono\": \"fas fa-bed\"},\r\n{ \"item\": \"TV de 42 Pulg\", \"icono\": \"fas fa-tv\"},\r\n{ \"item\": \"Agua Caliente\", \"icono\": \"fas fa-tint\"},\r\n{ \"item\": \"Baño privado\", \"icono\": \"fas fa-toilet\"},\r\n{ \"item\": \"Sofá\", \"icono\": \"fas fa-couch\"},\r\n{ \"item\": \"Balcón\", \"icono\": \"far fa-image\"},\r\n{ \"item\": \"Servicio Wifi\", \"icono\": \"fas fa-wifi\"}]', 300000, 250000, 380000, 350000, '2023-05-17 23:09:50'),
(3, 'habitacion-tipo-standar', '#2F7D84', 'standar', 'vistas/img/standar/portada.png', 'Lorem ipsum dolor sit amet', '[{\"item\":\"TV de 42 Pulg\",\"icono\":\"fas fa-tv\"},{\"item\":\"Agua Caliente\",\"icono\":\"fas fa-tint\"},{\"item\":\"Baño privado\",\"icono\":\"fas fa-toilet\"},{\"item\":\"Sofá\",\"icono\":\"fas fa-couch\"},{\"item\":\"Servicio Wifi\",\"icono\":\"fas fa-wifi\"}]', 250000, 200000, 350000, 300000, '2023-05-29 03:01:15');
...
(5, 'SPA', 'vistas/img/planes/plan-spa.png', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt blanditiis nulla expedita nostrum vero. Laborum repudiandae numquam mollitia earum natus ut delectus quas, iste unde doloribus suscipit qui, voluptate perspiciatis.</p>', 55000, 45000, '2023-05-29 17:31:19');

-- --------------------------------------------------------

--
-- Estrutura da tabela `recorrido`
--
...
--
-- Extraindo dados da tabela `recorrido`
--
...
--
-- Extraindo dados da tabela `reservas2`
--
...
--
-- Estrutura da tabela `testimonios`
--
...
--
-- Extraindo dados da tabela `testimonios`
--
...
(0, 'Sydney Fox', '$2a$07$asxx54ahjppf45sd87a5auRajNP0zeqOkB9Qda.dSiTb2/n.wAC/2', 'hemelaly02@gmail.com', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZ0KPK_ZIc-N0zV1a1_mDPGV4ictcp1SHCBO9ndz91_1aQ7eA&s', 'directo', 1, 'e0c28c0cd81f8aa6c7ca5bbdf19f1d9c', '2023-05-29 17:46:54'),
...
--
-- Índices para tabela `habitaciones`
--
...
--
-- Índices para tabela `testimonios`
--
...
--
-- AUTO_INCREMENT de tabela `habitaciones`
--
ALTER TABLE `habitaciones`
...
--
-- AUTO_INCREMENT de tabela `recorrido`
--
ALTER TABLE `recorrido`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT de tabela `reservas2`
--
ALTER TABLE `reservas2`
...
--
-- AUTO_INCREMENT de tabela `testimonios`
--
ALTER TABLE `testimonios`
