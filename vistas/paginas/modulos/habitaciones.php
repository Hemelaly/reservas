...
<div class="habitaciones container-fluid bg-light" id="habitaciones">
	...
	<div class="container">
		...
		<h1 class="pt-4 text-center">APARTAMENTOS</h1>
			...
			<div class="col-12 col-lg-4 pb-3 px-0 px-lg-3">
				...
				<a href="<?php echo $ruta.$value["ruta"];  ?>">
					...
					<figure class="text-center">
						...
						<h3 class="py-2 text-gray-dark mb-0">DESDE $<?php echo number_format($value["continental_baja"]); ?></h3>

						<h5 class="py-2 text-gray-dark border">Ver detalhes <i class="fas fa-chevron-right ml-2"></i></h5>
